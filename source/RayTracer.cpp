...
RayTracer::RayTracer() : m_triTreeUpdateTime(0), m_buildTriTreeTimeMilliseconds(0),
    m_buildPhotonMapTimeMilliseconds(0), m_photonMapUpdateTime(0), m_photonTraceTimeMilliseconds(0) {
...
static const Radiance3 BACKGROUND_RADIANCE(0.0f);
